...
**Precision Targeting:** Expert in Meta Ads Manager for Lead Gen and E-commerce.

**Technical Tracking:** Implementation of Server-Side GTM, Facebook Conversion API (CAPI), and custom event tracking.
